      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              href="/clients/new"
              className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl shadow-md hover:shadow-xl transition-all p-6"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold mb-1">Nuevo Cliente</p>
            ...
            <Link
              href="/clients"
              className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl shadow-md hover:shadow-xl transition-all p-6"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold mb-1">Mis Clientes</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold mb-1">Market Dashboard</p>
                  <p className="text-2xl font-bold">→</p>
                </div>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-slate-600 text-sm mb-4">
                  Evalúa la tolerancia al riesgo de tus clientes
                </p>
