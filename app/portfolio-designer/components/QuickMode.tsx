// app/portfolio-designer/components/QuickMode.tsx
// Modo Quick Build: Construcción rápida de carteras con plantillas
...
export default function QuickMode() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
        <div className="bg-white border border-gb-border rounded-lg p-8 mb-8">
          <h1 className="text-3xl font-bold text-gb-black mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border-2 border-gb-border rounded-lg focus:border-gb-accent focus:outline-none text-sm"
              >
          ...
          {assetClasses.map((assetClass) => (
            <div key={assetClass.id} className="bg-white border border-gb-border rounded-lg overflow-hidden">
              ...
              <button
                ...
                className="w-full p-6 flex items-center justify-between hover:bg-gb-light transition-colors"
              >
                <div className="flex items-center gap-4">
                  <div className="text-left">
                    <h2 className="text-2xl font-bold text-gb-black">
                      {assetClass.name}
                    </h2>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {assetClass.expanded ? (
                    <ChevronUp className="w-6 h-6 text-gb-gray" />
                  ) : (
                    <ChevronDown className="w-6 h-6 text-gb-gray" />
                  )}
                </div>
              </button>
                ...
                <div className="border-t border-gb-border">
                  <table className="w-full">
                    <thead className="bg-gb-light">
                      <tr>
                        <th className="px-6 py-3 text-left text-xs font-semibold text-gb-gray uppercase">
                          Region
                        </th>
                        <th className="px-6 py-3 text-center text-xs font-semibold text-gb-gray uppercase">
                          % Neutral
                        </th>
                        <th className="px-6 py-3 text-center text-xs font-semibold text-gb-gray uppercase">
                          % Modelo
                    ...
                    <tbody className="divide-y divide-gb-border">
                      {assetClass.allocations.map((allocation) => {
                        ...
                        return (
                          <tr key={allocation.region} className="hover:bg-gb-light transition-colors">
                            <td className="px-6 py-4">
                              <div>
                                <div className="font-semibold text-gb-black text-sm">
                            ...
                            <td className="px-6 py-4 text-center">
                              <div className="text-sm font-medium text-gb-dark">
                            ...
                            <td className="px-6 py-4 text-center">
                              <input
                                ...
                                className="w-20 px-2 py-1 text-center text-sm border border-gb-border rounded-lg focus:border-gb-accent focus:outline-none"
                              />
                            </td>
                            ...
                            <td className="px-6 py-4">
                              <select
                                ...
                                className="w-full px-3 py-2 border border-gb-border rounded-lg text-sm focus:border-gb-accent focus:outline-none"
                              >
