...
export default function ModeloCarteraPage() {
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">
                Constructor de Modelo de Cartera
              </h1>
              <p className="text-slate-600 mt-1">
                Diseña la estrategia de inversión perfecta para tu cliente
              </p>
            </div>
          </div>
        </header>
        ...
        <section className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border-2 border-slate-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-slate-200 rounded-lg pl-8 pr-20 py-2.5 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  <label
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border-2 rounded-lg cursor-pointer transition-all hover:border-blue-300"
                    style={{
                      borderColor:
                        universe === "global" ? "#3b82f6" : "#e2e8f0",
                      backgroundColor:
                        universe === "global" ? "#eff6ff" : "white",
                    }}
                  >
                    <input
                      type="radio"
                  ...
                  <label
                    ...
                    style={{
                      borderColor:
                        universe === "solo_chile" ? "#3b82f6" : "#e2e8f0",
                      backgroundColor:
                        universe === "solo_chile" ? "#eff6ff" : "white",
                    }}
                  >
                    <input
                      type="radio"
            ...
            <label className="flex items-center gap-2 px-4 py-3 bg-slate-50 rounded-lg border border-slate-200">
              <input
                type="checkbox"
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-3 px-6 rounded-lg hover:from-blue-700 hover:to-blue-800 disabled:from-slate-300 disabled:to-slate-400 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg"
            >
        ...
        {/* Información del perfil de riesgo */}
        {profile && allocation && (
          <section className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-lg border border-blue-200 p-6">
            <div className="flex items-center gap-2 mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <ScoreCard label="Percepción" score={profile.perception_score} />
            ...
            <div className="mt-4 p-4 bg-white rounded-lg border border-blue-200">
              ...
              <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                ...
                <div>
                  <span className="text-slate-600 font-medium">Renta Fija:</span>
        ...
        {/* Panel de Comentarios Automáticos */}
        ...
        {allocation && (
          <div className="flex flex-col md:flex-row justify-center gap-3 mt-8">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold py-3 px-6 rounded-xl hover:from-emerald-700 hover:to-emerald-800 disabled:from-slate-300 disabled:to-slate-400 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg"
            >
            ...
            <button
              ...
              disabled={!client}
              className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-indigo-700 disabled:from-slate-300 disabled:to-slate-400 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg"
            >
...
function AbsoluteValuesTable({
  ...
  return (
    <div
      className={`mt-4 rounded-xl border-2 p-4 ${colors.bg} ${colors.border}`}
    >
      <h4
      ...
      <div className="space-y-2">
        {rows.map(({ block, model }) => {
          const absoluteValue = (model / 100) * portfolioAmount;
          return (
            <div
              key={block.id}
              className="flex justify-between items-center bg-white rounded-lg px-4 py-2.5 border border-slate-200"
            >
      ...
      <div className={`mt-3 pt-3 border-t-2 ${colors.border}`}>
        <div className="flex justify-between items-center font-bold bg-white rounded-lg px-4 py-2.5">
          <span className="text-sm text-slate-700">Total {assetClass}:</span>
          <span className={`text-base ${colors.text}`}>
            $
            {rows
              .reduce(
                (sum, { model }) => sum + (model / 100) * portfolioAmount,
                0
              )
    ...
    >
      <p
        className={`text-sm font-semibold mb-1 ${
          highlight ? "text-blue-100" : "text-slate-600"
        }`}
      >
        {label}
      </p>
...
function AssetClassSection({
  ...
  return (
    <div
      className={`bg-gradient-to-br ${colors.bg} rounded-2xl shadow-lg border-2 ${colors.border} overflow-hidden`}
    >
      <button
        onClick={onToggle}
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      <input
                        ...
                        className="w-20 border-2 border-slate-200 rounded-lg px-2 py-1 text-right text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
                      />
                    </td>
                    <td className="px-4 py-3 text-right">
                      <span
                    ...
                    <td className="px-4 py-3">
                      {fundOptions && fundOptions.length > 0 ? (
                        <select
                          className="w-full border-2 border-slate-200 rounded-lg px-3 py-1.5 text-sm bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-4 flex justify-between items-center rounded-t-2xl">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold">Resumen Final del Modelo</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-3 px-6 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-md"
            >
              Imprimir Resumen
            </button>
            <button
              onClick={onClose}
              className="flex-1 bg-slate-200 text-slate-700 font-semibold py-3 px-6 rounded-lg hover:bg-slate-300 transition-all"
            >
              Cerrar
            </button>
          </div>
