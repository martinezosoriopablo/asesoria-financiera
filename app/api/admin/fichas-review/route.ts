...
export async function GET(request: NextRequest) {
  ...
  return handleApiError("fichas-review-get", async () => {
  const PAGE = 1000;
...
export async function PATCH(request: NextRequest) {
  ...
  return handleApiError("fichas-review-patch", async () => {
    ...
    const EDITABLE = ["tac_serie", "horizonte_inversion", "tolerancia_riesgo", "beneficio_apv", "beneficio_57bis", "beneficio_107lir", "beneficio_108lir", "notas_tributarias", "objetivo", "rent_1m", "rent_3m", "rent_6m", "rent_12m", "nombre_fondo_pdf", "pct_uf", "pct_renta_variable", "pct_renta_fija"];
