...
// Endpoint de seguimiento para el portal del cliente
...
// GET - Obtener datos consolidados de seguimiento para el cliente autenticado
export async function GET(request: NextRequest) {
  const blocked = await applyRateLimit(request, "portal-seguimiento", { limit: 30, windowSeconds: 60 });
  ...
  return handleApiError("portal-seguimiento-get", async () => {
    ...
    const recommendation = clientData.cartera_recomendada || null;
